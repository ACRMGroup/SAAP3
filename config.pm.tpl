...
# For the Interface: The URL for the SAAP server under the web server URL
$saapURL             = "/mutations/saapdap";

# For the Interface: The equivalent directory for the SAAP server web install
$saapWeb             = "$webRoot/mutations/saapdap";

# For the Interface: The temporary directory on the web server
