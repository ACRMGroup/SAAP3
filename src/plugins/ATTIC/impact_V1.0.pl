...
my $pdbcode = ExtractPDBCode($pdbfile);
...
impact.pl V1.0 (c) 2011, UCL, Dr. Andrew C.R. Martin
Usage: impact.pl [-v] [chain]resnum[insert] newaa pdbfile
